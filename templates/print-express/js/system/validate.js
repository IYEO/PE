var JFormValidator = function () {
    var $, handlers, inputEmail, custom, setHandler = function (name, fn, en) {
        ...
        if (state === false) {
            ...
            if ($el.closest("div.form-group").hasClass("has-success")) {
                $el.closest("div.form-group").removeClass("has-success");
                $el.closest("div.form-group").children("span.glyphicon-ok").remove();
            }

            if (!$el.closest("div.form-group").hasClass("has-error"))
                $el.closest("div.form-group").append("<span class=\"glyphicon glyphicon-remove form-control-feedback\" aria-hidden=\"true\"></span>");
            ...
            if ($el.closest("div.form-group").hasClass("has-error")) {
                ...
                $el.closest("div.form-group").children("span.glyphicon-remove").remove();
                $el.closest("div.form-group").append("<span class=\"glyphicon glyphicon-ok form-control-feedback\" aria-hidden=\"true\"></span>");
            }
        ...
        if (!valid && invalid.length > 0) {
            ...
            for (i = invalid.length - 1; i >= 0; i--) {
                ...
                if (label) {
                    ...
                    jQuery(invalid[i]).tooltip({html: true, container: "body", animation: true, title: message, delay: {show: "200", "hide": 100}});
                }
            }
        ...
        setHandler("phone", function (value) {
