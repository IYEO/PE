...
JHtml::script('system/core.js', FALSE, TRUE);   //фреймворк Joomla для отображения системных сообщений

JHtml::script('https://api-maps.yandex.ru/2.1/?lang=ru_RU');    //API Яндекс.Карт
JHtml::script('ya/map.js', FALSE, TRUE);    //загружаем свою Яндекс.Карту
JHtml::script('ya/panoramas.js', FALSE, TRUE);  //загружаем панорамы Принт-Экспресса, Позитива и Призмы
