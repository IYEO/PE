...
$output = '<input type="text" name="q" id="searchword" class="search-query form-control" size="'
...
$labelClass = (!$showLabel ? 'hidden ' : '') . 'finder sr-only';
$label      = '<label for="searchword" class="' . $labelClass . '">' . $params->get('alt_label', JText::_('JSEARCH_FILTER_SUBMIT')) . '</label>';
...
{
	$button = '<span class="input-group-btn"><button class="btn btn-primary finder" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><span class="glyphicon glyphicon-search"></span>' . /*JText::_('JSEARCH_FILTER_SUBMIT') . */'</button></span>';
...
<form id="search" action="<?php echo JRoute::_($route); ?>" method="get" class="collapse" role="search">
