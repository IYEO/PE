...
{
	$button = '<button class="btn btn-info hasTooltip ' . $suffix . ' finder' . $suffix . '" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><i class="icon-search"></i> Поиск</button>';
...
<form id="mod-finder-searchform" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search">
	<div class="finder input-append controls-row pull-right <?php echo $suffix; ?>">
		<?php
