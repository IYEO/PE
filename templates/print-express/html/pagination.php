...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.Print-Express
 *
...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<span class="glyphicon glyphicon-chevron-left"></span>';
	}
...
function pagination_item_inactive(&$item)
{
	...
	if ($item->text == JText::_('JPREV'))
	{
		return '<li class="disabled"><a><span class="glyphicon glyphicon-chevron-left"></span></a></li>';
	}

	// Check for "Next" item
	if ($item->text == JText::_('JNEXT'))
	{
		return '<li class="disabled"><a><span class="glyphicon glyphicon-chevron-right"></span></a></li>';
	}
